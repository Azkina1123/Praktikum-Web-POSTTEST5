...
<body>
        ...
        <div class="content">
          ...
          <table cellspacing="20">
            <form action="" method="POST" enctype="multipart/form-data" class="form container">
              ...
              <!-- tanggal update -->
              <tr>
                <td> <label for="date"> Released at* </label> </td>
                <td>
                  <center> : </center>
                </td>
                <td> <input type="date" name="date" id="date" value="<?= $product["released_date"]; ?>" readonly class="form-input"> </td>
              </tr>
              ...
              <tr>
                ...
                <td> <input type="file" name="image" id="image" accept="image/*" class="form-input"> </td>
              </tr>
  ...
  <script src="app/style.js?v=<?= time(); ?>"></script>
