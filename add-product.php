          ...
          <table cellspacing="20">
            ...
            <?php } else { ?>
              ...
              <form action="" method="POST" enctype="multipart/form-data" class="form container">
                <!-- tanggal update -->
                <tr>
                  <td> <label for="date"> Added at* </label> </td>
                  <td>
                    <center> : </center>
                  </td>
                  <td>
                    <input type="date" name="date" id="date" value="<?= date("Y-m-d"); ?>" readonly class="form-input">
                  </td>
                </tr>
                ...
                <!-- berat bersih -->
                <tr>
                  <td> <label for="net"> Net Weight </label> </td>
                  <td>
                    <center> : </center>
                  </td>
                ...
                <?php if ($_GET["product"] == "painting") { ?>
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="radio" name="frame" id="yes" value="1"> <label for="yes"> Yes </label> &nbsp;
                      <input type="radio" name="frame" id="no" value="0" checked> <label for="no"> No </label>
                    </td>
                  </tr>
